...
```bash
near account create-account sponsor-by-faucet-service nest-oracle-7.testnet autogenerate-new-keypair save-to-keychain network-config testnet create

near deploy nest-oracle-7.testnet ../../target/near/optimistic_oracle/optimistic_oracle.wasm
```

### 2. Initialize the contract

```bash
near contract call-function as-transaction nest-oracle-7.testnet new json-args '{
...
}' prepaid-gas '30 Tgas' attached-deposit '0 NEAR' sign-as nest-oracle-7.testnet network-config testnet sign-with-keychain send
```
...
near contract call-function as-transaction wrap.testnet ft_transfer_call json-args '{
  "receiver_id": "nest-oracle-7.testnet",
...
near contract call-function as-read-only nest-oracle-7.testnet get_minimum_bond json-args '{"currency": "wrap.testnet"}' network-config testnet now

# Get assertion details
near contract call-function as-read-only nest-oracle-7.testnet get_assertion json-args '{"assertion_id": [1,2,3,...,32]}' network-config testnet now
